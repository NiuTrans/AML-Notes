...
- 1.1 机器学习的数学基础 [[slides]](slides/第一章.pdf)

  - 1.1.1 张量代数与线性对象
  - 1.1.2 高级矩阵微积分与计算图
  - 1.1.3 凸优化理论与训练目标
  - 1.1.4 高维数据的表示与计算
- 1.2 机器学习机制与优化范式 [[slides]](slides/第一章.pdf)
  ...
  - 1.2.4 模型评估与模型选择
  - 1.2.5 正则化机制
- 1.3 深度神经网络基础 [[slides]](slides/第一章.pdf)

  - 1.3.1 多层感知机机制
  - 1.3.2 自注意力机制
  - 1.3.3 Encoder/Decoder 结构
- 1.4 表示学习机制 [[slides]](slides/第一章.pdf)

  - 1.4.1 分布式表示
  - 1.4.2 特征映射与表示空间
  - 1.4.3 预训练与表示迁移
- 1.5 本章小结 [[slides]](slides/第一章.pdf)

<a href="src/aml-notes.pdf#page=58" title="第二章 强化学习基础">2. 强化学习基础</a>


- 2.1 强化学习建模方法 [[slides]](slides/第二章.pdf)

  - 2.1.1 马尔可夫决策过程
  - 2.1.2 关键元素介绍
  - 2.1.3 优化目标
- 2.2 强化学习的基本优化算法 [[slides]](slides/第二章.pdf)

  - 2.2.1 基于价值函数的方法
  - 2.2.2 基于策略优化的方法
  - 2.2.3 Actor-Critic 框架
- 2.3 强化学习的进阶优化算法 [[slides]](slides/第二章.pdf)

  - 2.3.1 近端策略优化方法
  - 2.3.2 离线强化学习方法
- 2.4 强化学习的应用设计方法 [[slides]](slides/第二章.pdf)

  - 2.4.1 任务边界与转移定义
  - 2.4.2 状态表示与动作空间
  - 2.4.3 奖励与约束
  - 2.4.4 训练与评估过程设计
- 2.5 强化学习方法的挑战 [[slides]](slides/第二章.pdf)

  - 2.5.1 面向大规模决策的挑战
  - 2.5.2 强化学习训练的不稳定性和泛化性问题
  - 2.5.3 强化学习方法的奖励构建问题
- 2.6 本章小结 [[slides]](slides/第二章.pdf)

<a href="src/aml-notes.pdf#page=92" title="第三章 大模型预训练与微调方法">3. 大模型预训练与微调方法</a>


- 3.1 大模型预训练技术 [[slides]](slides/第三章.pdf)

  - 3.1.1 语言建模方法
  - 3.1.2 大语言模型架构
  - 3.1.3 大语言模型预训练方法
  - 3.1.4 缩放定律
- 3.2 提示学习方法 [[slides]](slides/第三章.pdf)

  - 3.2.1 Zero/One/Few-Shot 提示方法
  - 3.2.2 进阶提示方法
  - 3.2.3 学习提示
- 3.3 大模型微调技术 [[slides]](slides/第三章.pdf)

  - 3.3.1 微调概述
  - 3.3.2 有监督微调方法
  - 3.3.3 高效微调方法
- 3.4 大模型偏好对齐技术 [[slides]](slides/第三章.pdf)
  ...
  - 3.4.4 直接偏好优化
  - 3.4.5 偏好数据自动生成
- 3.5 大语言模型推理增强方法 [[slides]](slides/第三章.pdf)

  - 3.5.1 推理概述
  - 3.5.2 测试时缩放
  - 3.5.3 基于可校验奖励的强化学习方法
  - 3.5.4 从推理大模型到智能体
- 3.6 本章小结 [[slides]](slides/第三章.pdf)

<a href="src/aml-notes.pdf#page=144" title="第四章 深度学习中的连续动力学机制">4. 深度学习中的连续动力学机制</a>


- 4.1 连续动力学的数学基础 [[slides]](slides/第四章.pdf)

  - 4.1.1 从离散更新到连续演化
  - 4.1.2 常微分方程
  - 4.1.3 常微分方程的求解：积分表示与数值方法
- 4.2 表示空间中的连续动力学 [[slides]](slides/第四章.pdf)
...
- 4.3 确定性概率动力学 [[slides]](slides/第四章.pdf)
  ...
  - 4.3.4 Flow Matching
  - 4.3.5 概率路径设计
- 4.4 随机概率动力学 [[slides]](slides/第四章.pdf)
  ...
  - 4.4.5 概率流 ODE
  - 4.4.6 数值采样与高效生成
- 4.5 离散状态上的连续时间动力学 [[slides]](slides/第四章.pdf)
...
- 5.1 多模态表示学习与跨模态对齐 [[slides]](slides/第五章.pdf)

  - 5.1.1 单模态表示学习：从原始信号到向量
  - 5.1.2 自监督学习与预训练表示
  - 5.1.3 跨模态对齐
- 5.2 多模态基础模型结构与训练方法 [[slides]](slides/第五章.pdf)
  ...
  - 5.2.4 多模态指令微调与对齐
  - 5.2.5 图像—语音—文本联合建模
- 5.3 条件生成建模与多模态内容生成 [[slides]](slides/第五章.pdf)
  ...
  - 5.3.6 跨模态交互生成
- 5.4 本章小结 [[slides]](slides/第五章.pdf)
